...
# Load the EEPs
data_dir = os.getcwd()
filename_eep = os.path.join(data_dir, 'harp_beam', 'data_EEPs_SKALA41_random_100MHz.mat')
...
theta = np.concatenate((-theta_half[::-1], theta_half), axis=0) # to get theta from -pi/2 to pi/2
